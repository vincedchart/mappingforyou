	...
	layer: L.tileLayer('https://server.arcgisonline.com/ArcGIS/rest/services/World_Imagery/MapServer/tile/{z}/{y}/{x}', {
		...
		
			{
				...
				layer: {
					...
					{
				active: false,
				name: "Restauração (eating out)",
				icon: '<i class="icon icon-restaurant"></i>',
				layer: {
					type: "tileLayer.wms",
					args: ["http://mappingforyou.eu:8080/geoserver/wms", {
							layers: 'pt.poi.barrest',
							format: 'image/png',
							transparent: true,
							maxZoom: 20
							//minZoom: 13
				...
				layer: {
					...
					args: ["http://mappingforyou.eu:8080/geoserver/wms", {
							...
							//minZoom: 13
								...
								{
				active: false,
				name: "Serviços/emerg. (services/emerg.)",
				icon: '<i class="icon icon-emergency"></i>',
				layer: {
					type: "tileLayer.wms",
					args: ["http://mappingforyou.eu:8080/geoserver/wms", {
							layers: 'pt.poi.services',
							format: 'image/png',
							transparent: true,
							maxZoom: 20
							//minZoom: 13
								...
								{
				active: false,
				name: "Atividades (going out)",
				icon: '<i class="icon icon-loisirs"></i>',
				layer: {
					type: "tileLayer.wms",
					args: ["http://mappingforyou.eu:8080/geoserver/wms", {
							layers: 'pt.poi.loisirs',
							format: 'image/png',
							transparent: true,
							maxZoom: 20
							//minZoom: 13
...
layer: L.tileLayer('https://tiles.opensnowmap.org/pistes/{z}/{x}/{y}.png', { 
    ...
    maxZoom:20, 
										...
										{
				active: false,
				name: "Linha de contorno (cont. lines)",
				icon: '<i class="icon icon-mountains"></i>',
				layer: {
					type: "tileLayer.wms",
