...
var init = {"lat": 15, "lng": -61, "zoom": 8 }  
var southWest = L.latLng(3, -63), 
    northEast = L.latLng(18, -51), 
...
flickrAPI += "&has_geo=1"; 
// essai pour local 
flickrAPI += "&tags=Antilles%2CGuyane%2CMartinique%2CGuadeloupe" 
